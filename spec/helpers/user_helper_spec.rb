...
RSpec.describe V1::Helpers::UserHelper, type: :helper do
  ...
  describe "Follows a user" do
    ...
    it "follows the other user" do
      helper.follow_user(@this_user,@other_user)
